...
//ungets will cause the program to output many errors from ungetch if the buf limit is reached
//but it is possible to simply use ungetch. to avoid the errors, since it is all the same scope
//i use bufp to limit the loop
void ungets(char s[]){
	int i;
