...
Whether the number is positive or negative is irrelevant, since this is a process in which only bits and their locations are considered, not the numbers they represent.
