...
//0,31,28,31,30,31,30,31,31,30,31,30,31}char L[13] = {0,31,29,31,30,31,30,31,31,30,31,30,31};	
//static char *daytab[2] = {char *R = {0,31,28,31,30,31,30,31,31,30,31,30,31}, L};
